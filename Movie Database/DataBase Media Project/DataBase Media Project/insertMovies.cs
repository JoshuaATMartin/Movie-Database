...
{
    public partial class insertMovies : Form
    {
        string name;
        string year;
        float rating;
        ...
        private void InsertButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sqlCon.Open();
                    SqlCommand query = new SqlCommand("insert into movies(Name,Year,IMDB,Votes,Age_Restriction,Genre_1,Genre_2,Genre_3) VALUES ('" + name + "','" + year + "'," + rating + "," + votes + ",'" + age + "','" + genre1 + "','" + genre2 + "','" + genre3 + "')", sqlCon);
                    query.ExecuteNonQuery();
                    MessageBox.Show("Movie successfully added",null, MessageBoxButtons.OK);
