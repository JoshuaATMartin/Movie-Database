    ...
    public partial class deleteSeries : Form
    {
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sqlCon.Open();
                    SqlCommand query1 = new SqlCommand("delete from series where name = '" + nameTxt.Text + "'", sqlCon);
                    query1.ExecuteNonQuery();
                    MessageBox.Show("series successfully deleted", null, MessageBoxButtons.OK);
                    sqlCon.Close();
